#!/usr/bin/env python3
"""
Role: Regenerate t20_notebook_hydra_config_onboarding.ipynb only.
Used By:
...
Depends On:
 ...
 - nb_factory_core
Notes:
 - Run: ``python3 examples/tutorials/notebooks/temp_nb_factory/generate_t20_notebook_hydra_config_onboarding.py`` (repo root).
"""
...
NOTEBOOK_FILENAME = "t20_notebook_hydra_config_onboarding.ipynb"
