#!/usr/bin/env python3
"""
Role: Regenerate t14_network_local_http_simulation.ipynb only.
Used By:
...
Depends On:
 ...
 - nb_factory_core
Notes:
 - Run: ``python3 examples/tutorials/notebooks/temp_nb_factory/generate_t14_network_local_http_simulation.py`` (repo root).
"""
...
NOTEBOOK_FILENAME = "t14_network_local_http_simulation.ipynb"
