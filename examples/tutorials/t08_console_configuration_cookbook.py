        ...
        layers={
            "app": LogLayer(
                destinations=[
                    ...
                    LogDestination(
                        type="file",
                        path="logs/examples/tutorials/t08_colored_plaintext.jsonl",
                        format="json-lines",
                    ),
                ]
            )
        ...
        layers={
            "app": LogLayer(
                destinations=[
                    ...
                    LogDestination(
                        type="file",
                        path="logs/examples/tutorials/t08_no_color.log",
                        format="plain-text",
                    ),
                ]
            )
        ...
        layers={
            "api": LogLayer(
                destinations=[
                    ...
                    LogDestination(
                        type="file",
                        path="logs/examples/tutorials/t08_layer_api.jsonl",
                        format="json-lines",
                    ),
                ]
            ),
            "audit": LogLayer(
                destinations=[
                    ...
                    LogDestination(
                        type="file",
                        path="logs/examples/tutorials/t08_layer_audit.log",
                        format="plain-text",
                    ),
                ]
            ),
