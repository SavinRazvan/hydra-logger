...
def main() -> None:
    ...
    try:
        config.resolve_log_path("examples/logs/tutorials/t11_probe.jsonl")
    ...
    config.layers["api"] = LogLayer(
        ...
        destinations=[
            ...
            LogDestination(
                type="file",
                path="examples/logs/tutorials/t11_api_warn.jsonl",
                format="json-lines",
                level="WARNING",
            ),
        ],
    ...
    config.layers["audit"] = LogLayer(
        ...
        destinations=[
            LogDestination(
                type="file",
                path="examples/logs/tutorials/t11_audit.log",
                format="plain-text",
                level="WARNING",
            )
        ],
    ...
    config.layers["security"] = LogLayer(
        ...
        destinations=[
            ...
            LogDestination(
                type="file",
                path="examples/logs/tutorials/t11_security.jsonl",
                format="json-lines",
            ),
        ],
    )
    ...
    print(" - examples/logs/tutorials/t11_api_warn.jsonl")
    print(" - examples/logs/tutorials/t11_audit.log")
    print(" - examples/logs/tutorials/t11_security.jsonl")
