#!/usr/bin/env python3
"""
Role: Regenerate t12_network_http_typed_destination.ipynb only.
Used By:
...
Depends On:
 ...
 - nb_factory_core
Notes:
 - Run: ``python3 examples/tutorials/notebooks/temp_nb_factory/generate_t12_network_http_typed_destination.py`` (repo root).
"""
...
NOTEBOOK_FILENAME = "t12_network_http_typed_destination.ipynb"
