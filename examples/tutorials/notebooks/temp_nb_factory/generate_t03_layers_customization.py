#!/usr/bin/env python3
"""
Role: Regenerate t03_layers_customization.ipynb only.
Used By:
...
Depends On:
 ...
 - nb_factory_core
Notes:
 - Run: ``python3 examples/tutorials/notebooks/temp_nb_factory/generate_t03_layers_customization.py`` (repo root).
"""
...
NOTEBOOK_FILENAME = "t03_layers_customization.ipynb"
