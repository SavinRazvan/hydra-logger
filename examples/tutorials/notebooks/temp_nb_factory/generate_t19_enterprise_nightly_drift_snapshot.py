#!/usr/bin/env python3
"""
Role: Regenerate t19_enterprise_nightly_drift_snapshot.ipynb only.
Used By:
...
Depends On:
 ...
 - nb_factory_core
Notes:
 - Run: ``python3 examples/tutorials/notebooks/temp_nb_factory/generate_t19_enterprise_nightly_drift_snapshot.py`` (repo root).
"""
...
NOTEBOOK_FILENAME = "t19_enterprise_nightly_drift_snapshot.ipynb"
