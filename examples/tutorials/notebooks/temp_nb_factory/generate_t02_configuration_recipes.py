#!/usr/bin/env python3
"""
Role: Regenerate t02_configuration_recipes.ipynb only.
Used By:
...
Depends On:
 ...
 - nb_factory_core
Notes:
 - Run: ``python3 examples/tutorials/notebooks/temp_nb_factory/generate_t02_configuration_recipes.py`` (repo root).
"""
...
NOTEBOOK_FILENAME = "t02_configuration_recipes.ipynb"
