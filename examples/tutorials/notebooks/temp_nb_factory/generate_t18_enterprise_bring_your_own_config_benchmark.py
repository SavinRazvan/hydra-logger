#!/usr/bin/env python3
"""
Role: Regenerate t18_enterprise_bring_your_own_config_benchmark.ipynb only.
Used By:
...
Depends On:
 ...
 - nb_factory_core
Notes:
 - Run: ``python3 examples/tutorials/notebooks/temp_nb_factory/generate_t18_enterprise_bring_your_own_config_benchmark.py`` (repo root).
"""
...
NOTEBOOK_FILENAME = "t18_enterprise_bring_your_own_config_benchmark.ipynb"
