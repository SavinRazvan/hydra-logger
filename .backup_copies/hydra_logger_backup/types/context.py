...
This module provides comprehensive context type definitions for managing
...
class ContextManager:
    ...
    @classmethod
    def create_context(cls, context_type: ContextType = ContextType.CUSTOM,
                      metadata: Optional[Dict[str, Any]] = None) -> LogContext:
    ...
    @classmethod
    def get_or_create_context(cls, context_type: ContextType = ContextType.CUSTOM,
                             metadata: Optional[Dict[str, Any]] = None) -> LogContext:
...
def create_context(context_type: ContextType = ContextType.CUSTOM,
                  metadata: Optional[Dict[str, Any]] = None) -> LogContext:
    """Create a new logging context."""
