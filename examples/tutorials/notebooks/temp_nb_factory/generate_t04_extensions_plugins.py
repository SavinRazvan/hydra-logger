#!/usr/bin/env python3
"""
Role: Regenerate t04_extensions_plugins.ipynb only.
Used By:
...
Depends On:
 ...
 - nb_factory_core
Notes:
 - Run: ``python3 examples/tutorials/notebooks/temp_nb_factory/generate_t04_extensions_plugins.py`` (repo root).
"""
...
NOTEBOOK_FILENAME = "t04_extensions_plugins.ipynb"
