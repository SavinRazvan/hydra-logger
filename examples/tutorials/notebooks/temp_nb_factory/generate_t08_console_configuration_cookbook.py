#!/usr/bin/env python3
"""
Role: Regenerate t08_console_configuration_cookbook.ipynb only.
Used By:
...
Depends On:
 ...
 - nb_factory_core
Notes:
 - Run: ``python3 examples/tutorials/notebooks/temp_nb_factory/generate_t08_console_configuration_cookbook.py`` (repo root).
"""
...
NOTEBOOK_FILENAME = "t08_console_configuration_cookbook.ipynb"
