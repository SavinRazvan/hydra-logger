...
This file preserves historical changelog content that predates the current
auditable release-log format in `CHANGELOG.md`.

Use `CHANGELOG.md` as the canonical source for verified release notes.
