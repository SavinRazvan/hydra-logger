        ...
        layers={
            "api": LogLayer(
                destinations=[
                    LogDestination(
                        type="file",
                        path="logs/examples/tutorials/t03_layers_api.jsonl",
                        format="json-lines",
                    ),
                ]
            ),
            "database": LogLayer(
                destinations=[
                    LogDestination(
                        type="file",
                        path="logs/examples/tutorials/t03_layers_database.jsonl",
                        format="json-lines",
                    )
                ]
            ),
            "auth": LogLayer(
                destinations=[
                    LogDestination(
                        type="file",
                        path="logs/examples/tutorials/t03_layers_auth.jsonl",
                        format="json-lines",
                    ),
