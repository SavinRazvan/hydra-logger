...
Professional extension management system with full user control.
...
class ExtensionManager:
    """
    Professional extension manager with full user control.
    ...
    def register_extension_type(self, name: str, extension_class: Type[ExtensionBase]) -> None:
        """Register a new extension type."""
        self._available_types[name] = extension_class
    
    def create_extension(self, name: str, extension_type: str, enabled: bool = False, **config) -> ExtensionBase:
        """
