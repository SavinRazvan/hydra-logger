#!/usr/bin/env python3
"""
Role: Regenerate t01_production_quick_start.ipynb only.
Used By:
...
Depends On:
 ...
 - nb_factory_core
Notes:
 - Run: ``python3 examples/tutorials/notebooks/temp_nb_factory/generate_t01_production_quick_start.py`` (repo root).
"""
...
NOTEBOOK_FILENAME = "t01_production_quick_start.ipynb"
