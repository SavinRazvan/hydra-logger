#!/usr/bin/env python3
"""
Role: Regenerate t16_enterprise_config_templates_at_scale.ipynb only.
Used By:
...
Depends On:
 ...
 - nb_factory_core
Notes:
 - Run: ``python3 examples/tutorials/notebooks/temp_nb_factory/generate_t16_enterprise_config_templates_at_scale.py`` (repo root).
"""
...
NOTEBOOK_FILENAME = "t16_enterprise_config_templates_at_scale.ipynb"
